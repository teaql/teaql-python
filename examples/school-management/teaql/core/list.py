...
"Platform": {
    "table": "platform_data",
    "columns": {"id": "integer", "name": "text", "base_url": "text", "create_time": "date", "update_time": "date", "version": "integer"},
...
"School": {
    "table": "school_data",
    "columns": {"id": "integer", "platform": "integer", "school_type": "integer", "name": "text", "address": "text", "established_date": "date", "student_capacity": "integer", "active": "integer", "create_time": "date", "update_time": "date", "version": "integer"},
