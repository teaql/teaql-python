...
"Platform": {
    "table": "platform_data",
    "columns": {"id": "integer", "name": "text", "version": "integer"},
    "relations": {**{}, **{"work_item_list": {"target_entity": "WorkItem", "local_key": "id", "foreign_key": "platform", "many": True}}},
},
"WorkItem": {
    "table": "work_item_data",
    "columns": {"id": "integer", "title": "text", "description": "text", "platform": "integer", "version": "integer"},
    "relations": {**{"platform": {"target_entity": "Platform", "local_key": "platform", "foreign_key": "id", "many": False}}, **{}},
}
}
...
class TeaQLClient:
    ...
    async def query(self, context, req):
        ...
        if query._aggregates:
            ...
            return type('QueryResult', (object,), {'rows': [values]})
        ...
        return type('QueryResult', (object,), {'rows': result_rows})
